...
contract Searcher {
        ...
        returns (Opportunity memory opp)
    {
        ...
        // 6 triangle combinations across the 4 highest-liquidity mids.
        // Gas: ~20M total for check() — fine on QuickNode eth_call (50-100M cap).
        // This was disabled during Hardhat testing (16M cap) but works on real Arbitrum.
